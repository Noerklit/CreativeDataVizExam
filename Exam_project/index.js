...
d3.select("#title-container")
    ...
    .style("color", "#333")
    .text("Climate change is an everpresent topic in todays day and age. The seas and oceans of the world cover 71% of the earth's surface, but is this also something that might change, or is already changing? This project seeks to visualizes the changes in the depth of the major oceans of the world from a period of 1992-2023, to visualize a change that is not easily discernable to the naked eye.")
...
d3.json("oceans-topo-simple.json").then(function(data) {
    ...
    d3.csv("data.csv").then(function(csvData) {
        ...
        // Below is functions and constant used to simply gather min and max of every ocean to define colorscale
